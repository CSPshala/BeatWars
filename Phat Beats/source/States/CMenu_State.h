...
enum {MAINMENU_NEWGAME, MAINMENU_LOAD, MAINMENU_OPTIONS,  MAINMENU_CREDITS, MAINMENU_LEVEL, MAINMENU_ARCADE, MAINMENU_TUTORIAL,MAINMENU_HIGHSCORE, MAINMENU_EXIT, NUM_MAINMENU_OPTIONS};
